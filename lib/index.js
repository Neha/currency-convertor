...
export default CurrencyConverter = (price, baseCurrency, targetCurrency) => {
    return axios.get('http://data.fixer.io/api/latest?access_key=5cd55a2f9de07d559e48ee9cbdf4e6b1')
